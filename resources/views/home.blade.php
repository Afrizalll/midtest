  ...
  <!-- Page Heading -->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class="card-body">
                  <p>HALO,Selamat Datang Admin <b class="text-uppercase ">{{ Auth::user()->name }}, </b></p>
                  <p class="mb-0">Sistem Informasi Manajemen Perpustakaan "MY Perpus" <br> Jangan Berikan Email dan Password Anda pada Siapapun</p>
            </div>
        </div>
    </div>
</div>
